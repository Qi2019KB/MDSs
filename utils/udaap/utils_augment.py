...
class Augment(object):
    def __init__(self, aug_rate=0.5, num_occluder=8, datasetPath=None, datatype='animal'):
        self.obj_path = datasetPath if datasetPath is not None else 'D:/00Data/pose/animal_data/VOCdevkit/VOC2012'
