...
class PranavData:
    def __init__(self, inpRes=256):
        self.imgPath = "{}/data/pose/Openfield-Pranav/box_train/img".format(glob.root)
        self.labelPathname = "{}/data/pose/Openfield-Pranav/box_train/data.json".format(glob.root)
        self.imgType = "png"
        self.inpRes = inpRes
        self.kpsCount = 4
